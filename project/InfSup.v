...
From Coquelicot Require Import Rbar Compactness Lim_seq Rcomplements Hierarchy Lub.
From mathcomp Require Import ssrnat.
Require Import RbarComp FunImage SetTheory.


(* inf S is the infimum of S *)
Theorem is_inf_inf: forall A, 
  Rbar_is_glb A (Rbar_glb A).
...
Theorem is_sup_sup: forall A,
  Rbar_is_lub A (Rbar_lub A).
...
(* Exists supremum *)
Definition ex_sup (S : Ensemble R) :=
  exists l, is_lub S l.
  
(* Finite lower bound of a real set *)
...
(* Exists infimum *)
Definition ex_inf (S : Ensemble R) := 
  exists l, is_glb S l.

(* Set of supremums *)
Definition sup_ex (S : Ensemble R) := 
  { m : R | is_lub S m}.
...
(* Returns the supremum (given its existence) *)
Definition sup (S : Ensemble R)  (ex : sup_ex S) := 
  proj1_sig(ex).

(* Forall non-empty bounded set, there exists a supremum *)
Axiom ex_sup_cond: forall S,
  R_bounded S -> S <> Empty_set R -> sup_ex S.
...
Theorem ex_inf_opp: forall S, 
  ex_sup S <-> ex_inf (set_opp S).
...
Theorem ex_sup_opp: forall S, 
  ex_inf S <-> ex_sup (set_opp S).
...
Theorem sup_non_empty: forall S l, 
  is_lub S l -> exists s, S s.
...
Theorem inf_non_empty: forall S l, 
  is_glb S l -> exists s, S s.
...
(* The supremum of a set is equal to the opposite of the infimum of the opposite set *)
Theorem Lub_Rbar_opp: forall S, 
  Glb_Rbar S = Rbar_opp (Lub_Rbar (set_opp S)).
...
(* The infimum of a set is equal to the opposite of the supremum of the opposite set *)
Theorem Glb_Rbar_opp: forall S, 
  Lub_Rbar S = Rbar_opp (Glb_Rbar (set_opp S)).
...
Theorem sup_is_finite: forall S, 
  ex_sup S <-> is_finite (Lub_Rbar S).
...
Theorem is_sup_R_R: forall S l, 
  is_lub S l -> is_lub_Rbar S l.
...
Theorem inf_is_finite: forall S, 
  ex_inf S <-> is_finite (Glb_Rbar S).
...
(* If the supremum of a set exists then it is equal to the non finite one *)  
Theorem is_inf_R_R: forall S l, 
  is_glb S l -> is_glb_Rbar S l.
...
Theorem Rbar_is_lub_opp: forall S l, 
  Rbar_is_lub S l <-> Rbar_is_glb (set_opp_Rbar S) (Rbar_opp l).
...
(* The supremum of a set is equal to the opposite of the infimum of the opposite set *)
Theorem Rbar_lub_opp: forall S, 
  Rbar_lub S = Rbar_opp (Rbar_glb (set_opp_Rbar S)).
...
(* The infimum of a set is equal to the opposite of the supremum of the opposite set *)
Theorem Rbar_glb_opp: forall S,
  Rbar_glb S = Rbar_opp (Rbar_lub (set_opp_Rbar S)).
...
Theorem is_sup_R_Rbar: forall S l, 
  is_lub S l <-> Rbar_is_lub (set_R_to_Rbar S) l.
...
(* The supremum remains the same when a subset of R is converted in a subset of Rbar *)
Corollary sup_R_Rbar: forall (S : Ensemble R) (l : R), 
  is_lub S l <-> Rbar_lub (set_R_to_Rbar S) = l.
...
Proof.
  ...
  (* The supremum remains the same when a subset of R is converted in a subset of Rbar *)
Theorem is_sup_Rbar_Rbar: forall S l, 
  is_lub_Rbar S l <-> Rbar_is_lub (set_R_to_Rbar S) l.
...
(* The supremum remains the same when a subset of R is converted in a subset of Rbar *)
Theorem sup_Rbar_Rbar: forall S,
  Lub_Rbar S = Rbar_lub (set_R_to_Rbar S).
...
Lemma sup_le_union_l: forall A B : Ensemble Rbar, 
  Rbar_le (Rbar_lub A) (Rbar_lub (Union Rbar A B)).
...
(* The supremum of a set is smaller than the supremum of the union of this set with an other one *)
Lemma sup_le_union_r: forall A B : Ensemble Rbar,
  Rbar_le (Rbar_lub B) (Rbar_lub (Union Rbar A B)).
...
Lemma sup_singleton: forall x : Rbar,
  Rbar_is_lub (Singleton Rbar x) x.
...
Lemma sup_le_inter: forall A B : Ensemble Rbar,
  Rbar_le (Rbar_lub (Intersection Rbar A B)) (Rbar_min (Rbar_lub A) (Rbar_lub B)).
...
Theorem ge_is_sup: forall (a l : Rbar) (S : Ensemble Rbar), 
  (forall x, S x -> Rbar_le x a) /\ Rbar_is_lub S l -> Rbar_le (Rbar_lub S) a.
...
Corollary ge_sup: forall (a : Rbar) (S : Ensemble Rbar),
  ((forall x, S x -> Rbar_le x a) <-> Rbar_le (Rbar_lub S) a).
...
Theorem le_sup : forall (a : Rbar) (S : Ensemble Rbar),
  (exists x, S x /\ Rbar_le a x) -> Rbar_le a (Rbar_lub S).
...
Theorem sup_eq: forall (S : Ensemble Rbar) (l : Rbar),
  (forall x, S x -> Rbar_le x l) /\ (exists s, S s /\ s = l)  -> Rbar_lub S = l.
...
Theorem lt_sup: forall (a : Rbar) (S : Ensemble Rbar),
  Rbar_lt a (Rbar_lub S) -> (exists x, S x /\ Rbar_le a x).
...
Theorem sup_le_sup_image : forall (X : Ensemble R) (f g : R -> Rbar),
  (forall x: R, In R X x -> Rbar_le (f x) (g x)) -> Rbar_le (Rbar_lub (Im R Rbar X f)) (Rbar_lub (Im R Rbar X g)).
...
Theorem sup_independence: forall (a : Rbar) (X : Ensemble R) (f : R -> Rbar), 
  Rbar_plus a (Rbar_lub (Im R Rbar X f)) = Rbar_lub (Im R Rbar X (fun x => Rbar_plus (f x) a)). 
  
Admitted.
  
(* The supremum of ]-infinity, l[ is l *)

Theorem sup_R_set_lt (l : R) : 
  is_lub (fun t => t < l) l.
...
Theorem sup_R_set_ge_lt (l b : R) :
  b < l -> is_lub (fun t => b <= t < l) l.
...
Theorem is_inf_R_Rbar: forall S l,
  is_glb S l <-> Rbar_is_glb (set_R_to_Rbar S) l.
...
(* The infimum remains the same when a subset of R is converted in a subset of Rbar *)
Corollary inf_R_Rbar: forall (S : Ensemble R) (l : R),
  (is_glb S l <-> Rbar_glb (set_R_to_Rbar S) = l).
...
(* The infimum remains the same when a subset of R is converted in a subset of Rbar *)
Theorem is_inf_Rbar_Rbar: forall S l, 
  is_glb_Rbar S l <-> Rbar_is_glb (set_R_to_Rbar S) l.
...
Proof.
  ...
  Qed.
    ...
    (* The infimum remains the same when a subset of R is converted in a subset of Rbar *)
Theorem inf_Rbar_Rbar: forall S,
  Glb_Rbar S = Rbar_glb (set_R_to_Rbar S).
...
(* The supremum of a set is smaller than the supremum of the union of this set with an other one *)
Lemma inf_le_union_l: forall A B : Ensemble Rbar,
  Rbar_le (Rbar_glb (Union Rbar A B)) (Rbar_glb A).
...
(* The supremum of a set is smaller than the supremum of the union of this set with an other one *)
Lemma inf_le_union_r: forall A B : Ensemble Rbar,
  Rbar_le (Rbar_glb (Union Rbar A B)) (Rbar_glb B).
...
(* The supremum of a set is smaller than the supremum of the union of this set with an other one *)
Lemma is_inf_union: forall (A B : Ensemble Rbar) (l0 l1 : Rbar),
  Rbar_is_glb A l0 /\ Rbar_is_glb B l1 -> Rbar_is_glb (Union Rbar A B) (Rbar_min l0 l1).
...
(* The supremum of a set is smaller than the supremum of the union of this set with an other one *)
Corollary inf_union: forall A B : Ensemble Rbar,
  Rbar_glb (Union Rbar A B) = (Rbar_min (Rbar_glb A)(Rbar_glb B)).
...
(* The supremum of a singleton is its unique element *)
Lemma is_inf_singleton: forall x : Rbar,
  Rbar_is_glb (Singleton Rbar x) x.
...
(* The supremum of a singleton is its unique element *)
Corollary inf_singleton: forall x : Rbar,
  Rbar_glb (Singleton Rbar x) = x.
...
Theorem le_is_inf: forall (a l : Rbar) (S : Ensemble Rbar),
  (forall x, S x -> Rbar_le a x) /\ Rbar_is_glb S l -> Rbar_le a (Rbar_glb S).
...
(*If the set has a minimum and all the elements of the set are greater than a given a then the infimum will also be greater than a*)
Corollary le_inf: forall (a : Rbar) (S : Ensemble Rbar),
  ((forall x, S x -> Rbar_le a x) <-> Rbar_le a (Rbar_glb S)).
...
Theorem ge_inf: forall (a : Rbar) (S : Ensemble Rbar),
  (exists x, S x /\ Rbar_le x a) -> Rbar_le (Rbar_glb S) a.
...
(* If a given a is stricly smaller than the supremum of the set then there exist an element of the set that is greater than a *)
Theorem gt_inf: forall (a : Rbar) (S : Ensemble Rbar),
  Rbar_lt (Rbar_glb S) a -> (exists x, S x /\ Rbar_le x a).
...
Theorem lt_inf: forall (a : Rbar) (S : Ensemble Rbar),
  Rbar_lt a (Rbar_glb S) -> ~ S a.
...
Theorem inf_independence: forall (X : Ensemble R) (f : R -> Rbar) (a : R),
  Rbar_plus a (Rbar_glb (Im R Rbar X f)) = Rbar_glb (Im R Rbar X (fun x => Rbar_plus (f x) a)). 

Admitted.
  
(* If the infimum is greater and smaller than a value then it is equal to that value *)
Theorem inf_eq: forall (S: Ensemble Rbar) (l : Rbar),
  (forall x, S x -> Rbar_le l x) /\ (exists s, S s /\ s = l)  -> Rbar_glb S = l.
